...
from cao_routine_training.RSTAnet_transformer import ResNet1D_transformer,ResNet1DBlock_transformer
...
def main(lr_rate, project_name, configs):
    ...
    ecg_network = ResNet1D_transformer(ResNet1DBlock_transformer, [2, 2, 2, 2, 2, 2, 2], num_classes=num_class)
    # ecg_network = ResNet1D(ResNet1DBlock, [2, 2, 2, 2, 2, 2, 2], num_classes=num_class)
    mdfile1 = '/homeb/guofengyi/result/cao_paper/few_shot_result_txt/moco_4mamba_MSDNN_chapman.pth'
    ...
    test_dataset,_,_ = get_test_dataset(configs)
    ...
    for epoch in range(configs.epoch):
        if epoch % 1 == 0:
            ...
            with torch.no_grad():
                ...
                #                f'/homeb/guofengyi/result/cao_paper/fewshot/model/{configs.dataset_type_train}_to{configs.dataset_type_test}_{model_name}_lr{configs.final_lr}_bz_{configs.batch_size}_{configs.n_way}way_{configs.k_shot}_shot_{configs.n_query}_query.pth')
...
if __name__ == '__main__':
    ...
    configs.device = '1'
    configs.dataset_type_train = 'chapman'
    configs.dataset_type_test = 'PTB'
    model_name = "RSTAnet_transformer"
    configs.test_episode = 60
    best_Score_record = []
