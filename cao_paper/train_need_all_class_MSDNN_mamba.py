...
if __name__ == '__main__':
    ...
    for a in [0.5]:
        ...
        for i in ["chapman","PTB"]:
            ...
            project_name = "a="+str(alpha) + str(configs.k_shot)+"shot_" +"_new_two_network_rev_MCmamba_combine_label_"+"_"+configs.dataset_type+"_to_"+configs.dataset_type+"_"+str(num_tasks)
            #"a="+str(alpha)+
            ...
            for lr_rate in lr_rates:
                ...
                # best_threshold_7 = 0.0232
                # best_threshold_8 = 0.002321
