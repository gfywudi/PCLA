...
def main(lr_rate, project_name,configs):
    ...
    #     print("完成归一化，将要进行训练")
        ...
        for epoch in range(configs.epoch):
            ...
            for idx, batch in loop:
                ...
                # 计算损失
                query_labels_onehot = torch.nn.functional.one_hot(query_labels, num_classes=9)
                loss = -torch.sum(query_labels_onehot * torch.log(similarities + 1e-8)) / query_labels_onehot.size(0)
    ...
    Fold_result["hunxiao"] = np.array2string(cm_all, separator=', ')
...
def find_optimal_thresholds(label_list_onehot, pred_array):
    ...
    # if configs.dataset_type_train == "PTB":
    #     best_threshold_7 = 0.025
    #     best_threshold_8 = 0.025
    # elif configs.dataset_type_train == "chapman":
    #     best_threshold_7 = 8.822578711570545e-12
    #     best_threshold_8 = 5.327478572715946e-12
...
if __name__ == '__main__':
    ...
    for i in ['PTB']:
        ...
        project_name = str(configs.k_shot)+"shot_" "matching_net_Resmamba_combine_label_"+"_"+configs.dataset_type+"_to_"+configs.dataset_type+"_"+str(num_tasks)
